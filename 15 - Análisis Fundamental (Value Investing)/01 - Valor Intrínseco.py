...
# Definir ticker y obtener los datos
ticker = "AAPL"
accion = yf.Ticker(ticker)
flujo_de_caja = accion.cashflow

# Definir parámetros para el modelo de evaluación
...
# Proyectar FCF para los proximos años
...
#   - La tasa de descuento se utiliza para descontar los flujos de caja futuros al valor presente. Un 10% es una
#     tasa comúnmente utilizada que refleja el costo de capital de una empresa.
#   - La tasa de crecimiento terminal representa el crecimiento perpetuo del flujo de caja después del periodo de proyección.
#     Un 2% es una suposición conservadora que refleja el crecimiento a largo plazo de la economía.
#   - Un periodo de 5 años para proyectar los flujos de caja, es estándar y permite una proyección razonable sin ser demasiado incierto.
#   - El valor intrínseco es la valoración real de una empresa basada en fundamentos financieros, independiente de su precio de mercado.
